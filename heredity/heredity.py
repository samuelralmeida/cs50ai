...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if not mother and not father:
            person_probability = person_probability * PROBS["gene"][person_genes]

        else:
            mother_probability = None
            ...
            if person_genes == 2:
                ...
                person_probability = (
                    person_probability * (1 - mother_probability) * father_probability
        ...
        joint_probability = joint_probability * person_probability
