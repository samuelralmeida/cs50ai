...
def load_data(filename):
    ...
    with open(filename) as data:
        ...
        for row in reader:
            ...
            line.append(int(row[0]))  # Administrative
            line.append(float(row[1]))  # Administrative_Duration
            line.append(int(row[2]))  # Informational
            ...
            line.append(month_mapping[row[10]])  # Month
            line.append(int(row[11]))  # OperatingSystems
            line.append(int(row[12]))  # Browser
            line.append(int(row[13]))  # Region
            line.append(int(row[14]))  # TrafficType
            line.append(visitor_type_mapping[row[15]])  # VisitorType
